...
$query = "insert into cart (p_id,ip_add,qty,p_price,size) values ('$p_id','$ip_add','$product_qty','$product_price','small')";
...
<label class="col-md-5 control-label" >Product Quantity in KGs</label>
